...
public class SelfiesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			getFragmentManager().beginTransaction()
					.add(R.id.container, mSelfiesFragment).commit();
		}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
			...
			String selfieName = new SimpleDateFormat("yyyyMMdd_HHmmss")
					.format(new Date());
			SelfieRecord newSelfie = new SelfieRecord(selfieName, null);
			newSelfie
					.setPictureBitmap(SelfiesPictureHelper.getTempBitmap(this));
	...
	private void dispatchTakePictureIntent() {
		...
		takePictureIntent.putExtra(MediaStore.EXTRA_OUTPUT,
				Uri.fromFile(SelfiesPictureHelper.getTempFile(this)));
	...
	private void deleteAllSelfies() {
		...
		builder.setPositiveButton(getString(R.string.dialog_yes),
				dialogDeleteAllSelfiesClickListener);
		builder.setNegativeButton(getString(R.string.dialog_no),
				dialogDeleteAllSelfiesClickListener).show();
	}
	...
	private void deleteSelfie() {
		...
		builder.setPositiveButton(getString(R.string.dialog_yes),
				dialogDeleteSelfieClickListener);
		builder.setNegativeButton(getString(R.string.dialog_no),
				dialogDeleteSelfieClickListener).show();
	}
