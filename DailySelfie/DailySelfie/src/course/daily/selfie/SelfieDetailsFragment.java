...
public class SelfieDetailsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(R.layout.selfie_details_fragment,
				container, false);

		ImageView imageView = (ImageView) view
				.findViewById(R.id.selfie_details_picture_image_view);
		imageView.setImageBitmap(SelfiesPictureHelper.getScaledBitmap(
				mSelfie.getPicturePath(), 0, 0));
